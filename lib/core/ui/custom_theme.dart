...
abstract class CustomTheme {
  static theme() => ThemeData.light(useMaterial3: true).copyWith(
      ...
      cardTheme: const CardTheme(color:AppColors.primaryColor),
      checkboxTheme: const CheckboxThemeData(fillColor: MaterialStatePropertyAll(AppColors.secondaryColor),side: BorderSide(color: AppColors.secondaryColor)),
      textTheme: const TextTheme(
        ...
        displayMedium: TextStyle(fontSize: 24, fontWeight: FontWeight.normal, color: AppColors.secondaryColor),
